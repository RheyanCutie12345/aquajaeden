      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post">
              <h1 style="color: #00348d">Login as Delivery Personel</h1>
              <div>
              ...
              <div>
                ...
                <p>Log in as <a href="index.php">Admin</a></p>
              </div>
            ...
            if(isset($_POST['login'])){
              ...
              $select= "SELECT * FROM `delivery_user` WHERE `Username`= '$username'";
              ...
              if($data= mysqli_fetch_array($result)){
                ...
                if($uname==$username && $pass==$password){
                  ...
                  echo "<script>window.location.href='production/delivery.php'</script>";

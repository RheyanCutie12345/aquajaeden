            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href="delivery.php"><i class="fa fa-list-alt"></i> Delivery Details</a>
                  </li>
                      ...
                      <tbody>
                        <?php
                          ...
                          if($status=="In Queue"){
                            ...
                            $selectName= mysqli_query($db, "SELECT * FROM `payment_form` WHERE `payment_id`= '$payment_id'");
                            if($dataName= mysqli_fetch_array($selectName)){
                              $name= $dataName['Name'];
                              echo '  <tr><td>'.$name.'</td><td>'.$product.'</td><td align="center">'.$address.'</td><td align="center">'.$contact.'</td><td align="center">'.$total.'</td><td align="center"><span class="badge badge-success">'.$status.'</span></td>';
                              echo '<td align="center"><button onclick="location.href=\'update.php?id='.$id.'\'" type="button" href="update.php?id='.$id.'" class="btn btn-primary btn-sm" >Delivered</button> </td></tr>';
                            }

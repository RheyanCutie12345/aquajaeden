...
<html lang="en">
  <head>
    ...
    <title>Aqua Jaeden | Feedback</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Feedback<small>Messages</small></h2>
                    <div class="clearfix"></div>
                  </div>
              ...
              <div class="col-sm-12">
                  ...
                  <?php
                $select = mysqli_query($db, "SELECT * FROM `feedback`");
                while($data= mysqli_fetch_array($select)){
                  $email= $data['email'];
                  $message= $data['message'];
                echo ' <div class="messagebox"><h4>'.$email.'</h4><p>'.$message.'</p></div>  ';

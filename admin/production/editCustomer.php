            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                     ...
                     $select= mysqli_query($db, "SELECT * FROM `customer` WHERE `id`= '$customerId'");
                ...
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_content">
                      <div class="item form-group">
                        <div class="col-md-12 col-sm-12 ">
                         <h4>Control No: <?php echo $customerId; ?></h4>
                        </div>
                      </div>
                      <div class="item form-group">
                        <div class="col-md-12 col-sm-12 ">
                          <input value="<?php echo $name; ?>" name="fullname" required="required" class="form-control" type="text" placeholder="-             Fullname             -">
                        </div>
                      </div>
                      <div class="item form-group">
                        <div class="col-md-12 col-sm-12 ">
                          <input value="<?php echo $email; ?>" name="editEmail"  required="required" class="form-control" type="text" placeholder="-              Email             -">
                        </div>
                      </div>
                      <div class="item form-group">
                        <div class="col-md-12 col-sm-12 ">
                          <select name="consumerType" class="form-control">
                         <?php
                         if($consumerType=="Household"){
                          echo '   <option selected>Household</option>
                          <option>Small Business</option>
                          <option>Personal Consumption</option>';
                         }
                         if($consumerType=="Small Business"){
                          echo '   <option>Household</option>
                          <option selected>Small Business</option>
                          <option>Personal Consumption</option>';
                         }
                         if($consumerType=="Personal Consumption"){
                          echo '   <option>Household</option>
                          <option>Small Business</option>
                          <option selected>Personal Consumption</option>';
                         }
                         ?>
                          </select>
                        </div>
                        ...
                        <div class="modal-footer">
                          <a href="customer.php" class="btn btn-danger btn-sm"  style="margin-right: 46%"><i class="fa fa-times"></i>Close</a>
                    ...
                    <?php
                  if(isset($_POST['save'])){
                    $nameEdit= $_POST['fullname'];
                    $emailEdit= $_POST['editEmail'];
                    $consumer= $_POST['consumerType'];
                 
                    $insert= mysqli_query($db, "UPDATE `customer` SET `Name`= '$nameEdit', `Email`= '$emailEdit', `ConsumerType`= '$consumer' WHERE `id`= '$customerId'");
                    if($insert){

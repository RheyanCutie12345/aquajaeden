...
<html lang="en">
  <head>
    ...
    <title>Aqua Jaeden | Delivery Records</title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a href="deliveryrecord.php"><i class="fa fa-book"></i> Delivery Record</a>
                  </li>
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th style="width:18%">Date Delivered</th>
                      ...
                      <tbody>
                        <?php
                        $delivered= mysqli_query($db, "SELECT * FROM `payment_form`");
                        while($data= mysqli_fetch_array($delivered)){
                          $id=$data['payment_id'];
                          $name= $data['Name'];
                          $product= $data['Product'];
                          $total= $data['TotalAmount'];
                          $delete= "deleteRecord.php?id=".$id;
                          $delivery= mysqli_query($db, "SELECT * FROM `delivery` WHERE `payment_id`= '$id'");
                          if($id!=1000){
                            if($dataDelivery=mysqli_fetch_array($delivery)){
                              $date= $dataDelivery['Date_Delivered'];
                              $status= $dataDelivery['Status'];
                              if($status=="Delivered"){
                                echo ' <tr><td>'.$name.'</td><td>'.$date.'</td><td>'.$product.'</td><td>'.$total.'</td><td align="center"><span class="badge badge-secondary">'.$status.'</span></td>';
                                echo ' <td align="center"><a href="'.$delete.'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td></tr>';

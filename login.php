...
<html lang="en">
    <head>
        ...
        <!-- Webpage Title -->
        <title><?php if(isset($_COOKIE['user'])){
            echo $_COOKIE['user']; 
            }else{
                echo "Log in";
            }
            ...
            <div class="container">
                <div class="row">
                 ...
                 if(!empty($_COOKIE['user'])){
                    echo "<p>You are still sign in to another account. <a href='signout.php'>Sign Out First</a> Before Proceeding</p>";
                 }else{
                    echo "";
                 }
                   ?>
                    <form  method="post">
                            ...
                            <button type="submit" id="submit"  name="login" class="form-control-submit-button">Log In</button>
                   ...
                   if(isset($_POST['login'])){
                    ...
                    $check= mysqli_query($db, "SELECT * FROM `customer` WHERE `Email`='$email'");

                    $numrows= mysqli_num_rows($check);
          
                    if($numrows==0){
                        echo "<script>alert('Email is not registered Please Sign Up first');</script>";
